...
export function StaffCard({ member }: { member: StaffMember }) {
  ...
  return (
    <Reveal className="text-center">
      <div className="relative mx-auto mb-3 aspect-[3/4] w-full max-w-[210px] overflow-hidden rounded-card border border-white shadow" style={{ background: 'linear-gradient(150deg,#E01F1F,#15161A)' }}>
        {hasPhoto ? <Image src={member.photo!} alt={member.name} fill sizes="210px" className="object-cover" /> : <Silhouette />}
      </div>
